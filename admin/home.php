			...
			<ul id = "menu" class = "nav menu">
				...
				<li><a href = ""><i class = "glyphicon glyphicon-cog"></i> Accounts</a>
					<ul>
						...
						<li><a href = "user.php"><i class = "glyphicon glyphicon-cog"></i> User Nurse</a></li>
					</ul>
				</li>
				<li><li><a href = "patient.php"><i class = "glyphicon glyphicon-user"></i> Patient</a></li></li>
				<li><li><a href = "appointment.php"><i class = "glyphicon glyphicon-user"></i> Appointment</a></li></li>
