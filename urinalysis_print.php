...
<br />
	<div id="print">
		<div style = "margin:10px;">	
			<br />
			<img src = "images/hc.png" style = "float:left; margin-top:-20px; margin-left:50px;" height = "100px" width = "100px">
			<div style = "float:left; margin-left:50px;">	
				<label><center>SAN CARLOS CITY DIAGNOSTIC LABORATORY</center></label>
				<label style = "font-size:14px;"><center>SAN CARLOS, PANGASINAN</center></label>
